...
class ApiAction3(Action):
    def name(self):
        return "action_get_cricket_scorecard"
...
class ApiAction7(Action):
    def name(self):
        return "action_give_news"

    def run(self, dispatcher, tracker, domain):
        country = tracker.get_slot('country')
        response=requests.get('https://newsapi.org/v2/top-headlines?''country={}&''apiKey=1c641db096bd4d8d94c11cea964bb023'.format("in"))
